      ...
      <div className="w-full max-w-md">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Entre com sua conta para acessar seus cursos</CardDescription>
          </CardHeader>
          <form onSubmit={handleLogin}>
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Link href="/recuperar-senha" className="text-sm text-primary hover:underline" tabIndex={-1}>
                    Esqueceu a senha?
                  </Link>
                </div>
                <Input
            ...
            <CardFooter className="flex flex-col gap-4">
              ...
              <div className="text-center text-sm text-muted-foreground">
                Não tem uma conta?{" "}
                <Link href="/registrar" className="text-primary hover:underline font-medium">
                  Criar conta
                </Link>
              </div>
            </CardFooter>
